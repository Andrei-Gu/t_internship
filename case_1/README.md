...
Исходя из условий задания, будем считать что блокировка / разблокировка платежей клиента происходит по информации, получаемой только от одного Источника, и важна только дата начала и окончания блокировки.
